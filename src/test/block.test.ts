...
e..e`;
    ...
    test("Test align spacing", function() {
        /* helper function so we can compare line more easily, could be moved somwhere outside if other tests need it */
...
This is fucking awesome.`;
        ...
        currentLine++;
        assert.deepEqual(block.lines[currentLine].number, 1);
